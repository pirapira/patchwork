...
Yet another fork with removed autolinking.
Plus ability to define custom formatters:

  class Article < ActiveRecord::Base
    acts_as_textiled :body => ArticleFormatter, :abstract => [ArticleFormatter, :lite_mode]
  end
